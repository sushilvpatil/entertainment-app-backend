...
import { searchMoviesHandler, searchTVShowsHandler, getMovieDetails,getMovieURL,getMovieCasts,getTVSeries,getTVSeriesURL,getTVSeriesCast} from '../controllers/movieController.js';
...
router.get("/tv-series/:id/cast", authMiddleware, getTVSeriesCast);
